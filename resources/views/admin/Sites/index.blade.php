...
@section('content')
    ...
    @else
        <div class="alert alert-danger mb-4 text-warning text-center">
            ...
            <p class="text-danger">هیچ سایتی وجود ندارد لطفا با کلیک بر روی گزینه <a href="{{ route('sites.create') }}"><button class="btn btn-primary btn-sm">ایجاد سایت</button></a> یک سایت جدید ایجاد کنید</p>
        </div>
    @endif
@endsection
@section('JS')
